...
func (p *Properties) SkinURL() (url string, ok bool) {
...
func (p *Properties) CapeURL() (url string, ok bool) {
...
func (p *Properties) SkinReader() (io.ReadCloser, error) {

	return readTexture(p.skinURL, errNoSkin)
}
...
//
// It is the client's responsibility to close the ReadCloser.
func (p *Properties) CapeReader() (io.ReadCloser, error) {

	return readTexture(p.capeURL, errNoCape)
}
